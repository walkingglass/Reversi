...
char Board::Player_A = PLAYER;
char Board::Player_B = AI;
uint8_t Board::Background_color = 42;
uint8_t Board::Player_A_color = 37;
uint8_t Board::Player_B_color = 37;
short Board::normal_point = 100;
short Board::bonus_point = 1000;
short Board::penalty_point = -1800;
double Board::random = 0.9;
short Board::delar_time = 10;
bool Board::Mouse_movement_display = true;//false
bool Board::Mouse_right_display = true;
bool Board::AI_skip = true;
