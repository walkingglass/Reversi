...
{   
    ...
    do {
        ...
        while (TRUE)
        {
            ...
            if (reversi.Player_A == AI && reversi.Player_B == AI)
            {
                if (reversi.wave % 2 == 1)
            ...
            else
            {
                ...
                if ((reversi.wave % 2 == 1 && reversi.Player_A == PLAYER)|| (reversi.wave % 2 == 0 && reversi.Player_B == PLAYER))
                {
