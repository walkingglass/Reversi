                ...
                if (irInBuf[i].EventType == MOUSE_EVENT)//判斷目前事件是否為滑鼠事件
                {
                    ...
                    if (strcmp(string, "main") == 0)
                    {
                        ...
                        else if (mouseEvent.dwButtonState == FROM_LEFT_1ST_BUTTON_PRESSED)//滑鼠左鍵
                        {
                            ...
                            if (mouseX >= BOARD_SIZE * 2 + 6 && mouseY >= 9 && mouseX <= BOARD_SIZE * 2 + 11 && mouseY <= 11)return 4;
                            return 0;
                        }
                    ...
                    if (strcmp(string, "set") == 0)
                    {
                        ...
                        else if (mouseEvent.dwButtonState == FROM_LEFT_1ST_BUTTON_PRESSED)//滑鼠左鍵
                        {
                            ...
                            {
                                if (mouseY == 3 /*&& set_mouse.Player_B == PLAYER*/)set_mouse.Player_A = AI;
                                else if (mouseY == 4 /*&& set_mouse.Player_A == PLAYER*/)set_mouse.Player_B = AI;
                                /*else if (mouseY == 3 && set_mouse.Player_B == AI)
                                {
                                    set_mouse.Player_A = AI;
                                    set_mouse.Player_B = PLAYER;
                                }
                                else if (mouseY == 4 && set_mouse.Player_A == AI)
                                {
                                    set_mouse.Player_B = AI;
                                    set_mouse.Player_A = PLAYER;
                                }*/
                            }
                            ...
                            {
                                (mouseX >= 17 && mouseX <= 23)?printf("\33[%d;18H       ", mouseY+1): printf("\33[%d;36H       ", mouseY + 1);//清除
                                printf("\33[3;50H               ");//清除
                    ...
                    if ((strcmp(string, "start") == 0) || (strcmp(string, "end") == 0) || (strcmp(string, "AI") == 0))
                    {
                        ...
                        if (strcmp(string, "start") == 0)
                        {
                            ...
                            if (mouseEvent.dwButtonState & RIGHTMOST_BUTTON_PRESSED)//滑鼠右鍵
                            {
                                if (mouseX< (Width * 0.7 + 1) && mouseX >(Width * 0.3 - 1))
                                    if (mouseY< (Height * 0.6) && mouseY >(Height * 0.3))
                                        return 0;
                        ...
                        else if (strcmp(string, "AI") == 0)
                        {
                            ...
                            setCursorPosition(Width * 0.432 + Width * Width * 0.0001f, Height * 0.75);//微調放大螢幕的歪斜
                            printf("\33[5m點擊\33[34m標題\33[0m\33[5m開始調適\33[0m");
                            if (mouseEvent.dwEventFlags == MOUSE_MOVED)//滑鼠移動
                            {
